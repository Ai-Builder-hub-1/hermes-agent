...
Generated: 2026-08-14T19:08:04.703Z
...
| media-engine | needs-implementation-migration | package-native | T3C | 89% | 89% | T3C/package-native claim still contains static, compatibility, bridge, local primitive, or migration language<br>missing core kit component evidence: sidebar |
...
| investing-system | needs-implementation-migration | package-native | T3C | 100% | 100% | T3C/package-native claim still contains static, compatibility, bridge, local primitive, or migration language |
...
Surfaces:
- `media-engine-ops-active` `core/operations/unified-publishing-dashboard.js` (ui): families shell, header, state, metrics, tables, charts, workflow, proof; local signals local-sidebar-class, local-card-class, hand-authored-table, hardcoded-spacing, hardcoded-color
...
Surfaces:
- `investing-system-roc` `public/roc/index.html` (compatibility): families shell, sidebar, header, state, metrics, tables, charts, workflow, proof; local signals local-sidebar-class, local-card-class, hardcoded-spacing
