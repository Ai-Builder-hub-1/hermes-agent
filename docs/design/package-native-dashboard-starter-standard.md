...
New dashboard products must start package-native. Static adapters are a legacy
bridge for existing dashboards, not the default build path.

## Rule

Any new Tier 3 dashboard must:
