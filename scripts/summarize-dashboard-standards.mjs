...
const checks = [
  ...
  {
    id: "domain-libraries",
    script: "dashboard:domain-libraries:validate",
    version: "V13",
    required: true,
  },
  {
    id: "domain-library-coverage",
    script: "dashboard:domain-libraries:coverage:strict",
    version: "V13",
    required: true,
  },
  {
    id: "domain-wrapper-proof",
    script: "dashboard:domain-wrappers:proof:strict",
    version: "V13",
    required: true,
  },
  {
    id: "domain-library-usage",
    script: "dashboard:domain-libraries:usage:strict",
    version: "V13",
    required: true,
  },
  {
    id: "ui-quality-design-debt",
    script: "dashboard:ui-quality:debt:strict",
    version: "V14",
    required: true,
  },
  {
    id: "ui-quality-scorecard",
    script: "dashboard:ui-quality:scorecard",
    version: "V14",
    required: true,
  },
  {
    id: "visual-regression-matrix",
    script: "dashboard:visual-regression:matrix",
    version: "V14",
    required: true,
  },
  {
    id: "ui-quality-system",
    script: "dashboard:ui-quality:validate",
    version: "V14",
    required: true,
  },
  {
