...
export function DashboardShell({ sidebar, header, children, className, }) {
    return (_jsx("div", { className: cn("min-h-0 w-full", className), "data-component": "DashboardShell", children: _jsxs("div", { className: "grid min-h-0 gap-4 lg:grid-cols-[minmax(13.5rem,16.5rem)_minmax(0,1fr)]", children: [sidebar ? _jsx("aside", { className: "min-w-0", "data-component": "DashboardSidebar", children: sidebar }) : null, _jsxs("section", { className: "min-w-0 space-y-4", "data-component": "DashboardWorkspace", children: [header, _jsx(DashboardMain, { children: children })] })] }) }));
}
...
export function DashboardHeader({ title, eyebrow, description, actions, meta, className, }) {
    return (_jsxs("header", { className: cn("hdk-command-header flex flex-wrap items-start justify-between gap-4 rounded-lg border border-border bg-card p-4", className), "data-component": "DashboardHeader", children: [_jsxs("div", { className: "min-w-0", children: [eyebrow ? _jsx("div", { className: "mb-1 text-xs font-medium uppercase tracking-wide text-muted-foreground", children: eyebrow }) : null, _jsx("h1", { className: "truncate text-2xl font-semibold text-foreground", children: title }), description ? _jsx("p", { className: "mt-1 max-w-3xl text-sm text-muted-foreground", children: description }) : null, meta ? _jsx("div", { className: "mt-3 flex flex-wrap gap-2", children: meta }) : null] }), actions ? _jsx("div", { className: "flex shrink-0 flex-wrap items-center gap-2", children: actions }) : null] }));
}
export function DashboardSidebar({ title, description, items, footer, className, }) {
    return (_jsxs("nav", { className: cn("hdk-sidebar-rail rounded-lg border border-border bg-card p-3", className), "aria-label": title, "data-component": "DashboardSidebar", children: [_jsxs("div", { className: "hdk-sidebar-brand border-b border-border pb-3", children: [_jsx("div", { className: "hdk-sidebar-title text-sm font-semibold text-foreground", children: title }), description ? _jsx("div", { className: "hdk-sidebar-description mt-1 text-xs text-muted-foreground", children: description }) : null] }), _jsx("div", { className: "hdk-sidebar-nav mt-3 space-y-1", children: items.map((item) => {
                ...
                }) }), footer ? _jsx("div", { className: "hdk-sidebar-footer mt-4 border-t border-border pt-3", children: footer }) : null] }));
}
