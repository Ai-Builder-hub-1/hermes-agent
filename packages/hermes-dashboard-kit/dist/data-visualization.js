...
export function PriceMovementChart({ data, state = "ready", height = 260, title = "Mid price movement", }) {
    ...
    return (_jsx(VisualizationStateFrame, { state: state, title: title, children: _jsx("div", { className: "rounded-lg border border-border bg-card p-3", style: { height }, role: "img", "aria-label": title, children: _jsx(ResponsiveContainer, { height: "100%", width: "100%", children: _jsxs(AreaChart, { data: data, margin: { bottom: 4, left: -18, right: 10, top: 14 }, children: [_jsx("defs", { children: _jsxs("linearGradient", { id: "hdk-mid-price-fill", x1: "0", x2: "0", y1: "0", y2: "1", children: [_jsx("stop", { offset: "0%", stopColor: "var(--hdk-status-success, hsl(var(--primary)))", stopOpacity: 0.32 }), _jsx("stop", { offset: "100%", stopColor: "var(--hdk-status-success, hsl(var(--primary)))", stopOpacity: 0.02 })] }) }), _jsx(CartesianGrid, { stroke: "hsl(var(--border))", strokeDasharray: "2 6", vertical: false }), _jsx(XAxis, { dataKey: "label", fontSize: 11, stroke: "hsl(var(--muted-foreground))", tickLine: false }), _jsx(YAxis, { fontSize: 11, stroke: "hsl(var(--muted-foreground))", tickFormatter: (value) => `${value}c`, tickLine: false }), _jsx(Tooltip, { contentStyle: tooltipStyle, formatter: (value) => [`${Number(value).toFixed(1)}c`, "mid price"] }), _jsx(Area, { dataKey: "midPrice", fill: "url(#hdk-mid-price-fill)", name: "mid price", stroke: "var(--hdk-status-success, hsl(var(--primary)))", strokeWidth: 3, type: "monotone" })] }) }) }) }));
}
...
export function ForecastConeChart({ data, state = "ready", height = 240, title = "Forecast cone", }) {
    ...
    return (_jsx(VisualizationStateFrame, { state: state, title: title, children: _jsx("div", { className: "rounded-lg border border-border bg-card p-3", style: { height }, role: "img", "aria-label": title, children: _jsx(ResponsiveContainer, { height: "100%", width: "100%", children: _jsxs(ComposedChart, { data: normalized, margin: { bottom: 2, left: -18, right: 10, top: 10 }, children: [_jsx(CartesianGrid, { stroke: "hsl(var(--border))", strokeDasharray: "2 6", vertical: false }), _jsx(XAxis, { dataKey: "label", fontSize: 11, stroke: "hsl(var(--muted-foreground))", tickLine: false }), _jsx(YAxis, { fontSize: 11, stroke: "hsl(var(--muted-foreground))", tickFormatter: (value) => `${Number(value).toFixed(0)}c`, tickLine: false }), _jsx(Tooltip, { contentStyle: tooltipStyle, formatter: (value, name) => [`${Number(value).toFixed(1)}c`, name] }), _jsx(Area, { dataKey: "high", fill: "var(--hdk-status-info, hsl(var(--primary)))", fillOpacity: 0.12, name: "high", stroke: "var(--hdk-status-info, hsl(var(--primary)))", strokeOpacity: 0.24, type: "monotone" }), _jsx(Area, { dataKey: "low", fill: "hsl(var(--card))", fillOpacity: 1, name: "low", stroke: "var(--hdk-status-info, hsl(var(--primary)))", strokeOpacity: 0.24, type: "monotone" }), _jsx(Line, { dataKey: "expected", dot: false, name: "expected", stroke: "hsl(var(--foreground))", strokeWidth: 2.5, type: "monotone" }), _jsx(Line, { dataKey: "actual", dot: false, name: "actual", stroke: "var(--hdk-status-success, hsl(var(--primary)))", strokeDasharray: "4 4", strokeWidth: 2, type: "monotone" })] }) }) }) }));
}
