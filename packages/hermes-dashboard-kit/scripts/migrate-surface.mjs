...
const plan = {
  ...
  targetMode: "package-native @hermes/dashboard-kit import",
  ...
  migrationSteps: [
    "Confirm the production dashboard route imports @hermes/dashboard-kit directly.",
    "Keep hermes-dashboard-kit static CSS only as a temporary migration bridge or compatibility fallback.",
